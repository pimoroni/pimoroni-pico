...
namespace pimoroni {
  ...
  class UC8159 {
  public:
    typedef bool (*is_busy_callback_t)();
  ...
  private:
    ...
    is_busy_callback_t  is_busy_callback = nullptr;
  ...
  public:
    ...
    //--------------------------------------------------
  public:
    void init(bool rotate_180 = false);
    void busy_wait();
    void set_is_busy_callback(is_busy_callback_t func);
