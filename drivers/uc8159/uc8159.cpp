...
namespace pimoroni {
  ...
  void UC8159::set_is_busy_callback(is_busy_callback_t func) {
    is_busy_callback = func;
  }

  bool UC8159::is_busy() {
    if(is_busy_callback) {
      return is_busy_callback();
    }
  ...
  void UC8159::init(bool rotate_180) {
  ...
  void UC8159::setup() {
   ...
   uint8_t orientation = rotate_180 ? 0b00000000 : 0b00001100;
    ...
    command(PSR, {
      (uint8_t)(((width == 640) ? 0b10100011 : 0b11100011) | orientation),
