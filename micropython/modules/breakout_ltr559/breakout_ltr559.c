...
/***** Methods *****/
MP_DEFINE_CONST_FUN_OBJ_1(BreakoutLTR559_reset_obj, BreakoutLTR559_reset);
...
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_interrupts_obj, 2, BreakoutLTR559_interrupts);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_proximity_led_obj, 2, BreakoutLTR559_proximity_led);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_light_control_obj, 2, BreakoutLTR559_light_control);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_proximity_control_obj, 2, BreakoutLTR559_proximity_control);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_light_threshold_obj, 2, BreakoutLTR559_light_threshold);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_proximity_threshold_obj, 2, BreakoutLTR559_proximity_threshold);
MP_DEFINE_CONST_FUN_OBJ_KW(BreakoutLTR559_light_measurement_rate_obj, 2, BreakoutLTR559_light_measurement_rate);
...
STATIC const mp_rom_map_elem_t BreakoutLTR559_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_reset), MP_ROM_PTR(&BreakoutLTR559_reset_obj) },
