...
STATIC const mp_map_elem_t picographics_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_DISPLAY_INTERSTATE75), MP_ROM_INT(DISPLAY_INTERSTATE75_32X32) },
    { MP_ROM_QSTR(MP_QSTR_DISPLAY_INTERSTATE75), MP_ROM_INT(DISPLAY_INTERSTATE75_64X64) },
    { MP_ROM_QSTR(MP_QSTR_DISPLAY_INTERSTATE75), MP_ROM_INT(DISPLAY_INTERSTATE75_64X32) },
