function (copy_module TARGET SRC DIR DST)
    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/../modules/${DIR}/${DST}.py

        COMMAND
            mkdir -p ${CMAKE_CURRENT_BINARY_DIR}/../modules/${DIR}
        COMMAND
            cp ${SRC} ${CMAKE_CURRENT_BINARY_DIR}/../modules/${DIR}/${DST}.py

        DEPENDS ${src}
    )

    target_sources(${TARGET} INTERFACE ${CMAKE_CURRENT_BINARY_DIR}/../modules/${DIR}/${DST}.py)
endfunction()
