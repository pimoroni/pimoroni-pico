...
"""
This example sets your Pico W Explorer's screen to the current #cheerlights colour.
...
while True:
    ...
    display.text("Tweet a colour at #cheerlights to change!", 10, 130, WIDTH - 30, scale=3)
    display.update()
