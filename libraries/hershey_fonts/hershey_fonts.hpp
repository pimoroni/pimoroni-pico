...
namespace hershey {
  ...
  int32_t measure_glyph(const font_t* font, unsigned char c, float s, float k = 1.0f);
  int32_t measure_text(const font_t* font, std::string message, float s, float k = 1.0f);
